...
export default function LogData() {
  let [excelData,setexcelData] = useState<[any, any] | []>([])
  ...
  let rowData = LogData.map((item)=>{
    ...
    return (
      <div key={item.id} className="grid grid-cols-4 gap-5  hover:bg-slate-700 duration-200 cursor-pointer text-center">
  ...
  return (
    <div className="h-[90vh] bg-black flex">
     <div className='w-[20vw] h-full overflow-auto'>
      ...
      <input type="date" value={selectedDate} onChange={(e)=>setselectedDate(e.target.value)} className='my-2 px-5 py-2 rounded-xl text-[#ff00ff] bg-[#212121]'/>
