  ...
  return (
    <div className='h-[10vh] bg-slate-900 flex justify-between items-center p-5 border-b-cyan-600 border-2 border-slate-900'>
      ...
      <div className='flex gap-10'>
        <Link to='/'><div className='text-white text-2xl font-bold hover:text-cyan-600 duration-200 cursor-pointer'>Transaction</div></Link>
        <Link to='/stock'><div className='text-white text-2xl font-bold hover:text-cyan-600 duration-200 cursor-pointer'>Stock</div></Link>
        <Link to='/logs'><div className='text-white text-2xl font-bold hover:text-cyan-600 duration-200 cursor-pointer'>Logs</div></Link>
        <Link to='/monthly'><div className='text-white text-2xl font-bold hover:text-cyan-600 duration-200 cursor-pointer'>Monthly</div></Link>
      </div>
    </div>
  )
}
